...
<html lang="en">
  <head>
    <title>Labsi Asisten Portal - Login</title>
    <meta charset="utf-8">
          ...
          <div class="card-body">
            <form method="POST" action="{{ route('login') }}">
              ...
              <div class="form-group">
                ...
                <input type="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email') }}" name="email" id="email" placeholder="email@example.com">
                @error('email')
